...
export const httpRequestDuration = new client.Histogram({
  name: 'dicomcloud_http_request_duration_seconds',
...
export const edgeAgentsConnected = new client.Gauge({
  name: 'dicomcloud_edge_agents_connected',
